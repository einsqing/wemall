...
// +----------------------------------------------------------------------
// | Author: cuitengwei <cuitengwei@mumayi.com>
// |
// +----------------------------------------------------------------------
...
class Pagemumayi {
    ...
    public function show() {
        ...
        if ($upRow>0){
            $upPage     =   "<a href='".str_replace('__PAGE__',$downRow,$url).".html'>".$this->config['next']."</a>";
        }else{
            $upPage     =   '';
        }

        if ($downRow <= $this->totalPages && $upRow>0){

            $downPage   =   "<a href='".str_replace('__PAGE__',$upRow,$url).".html'>".$this->config['prev']."</a>";
        }else{
            $downPage   =   '';
        }
        // << < > >>
        if($nowCoolPage == 1){
            ...
            $prePage    =   "<a href='".str_replace('__PAGE__',$preRow,$url)."'.html >上".$this->rollPage."页</a>";
        ...
        if($nowCoolPage == $this->coolPages){
            ...
            $nextPage   =   "<a href='".str_replace('__PAGE__',$nextRow,$url)."'.html >下".$this->rollPage."页</a>";
        ...
        if(trim($pageStr)=='-') {
            ...
            $pagestrD = str_replace(array('>/<','> /<','/<','> /'),array('><','><','<','>'),$pageStr);

            return str_replace($this->replaceS,$this->replaceE,$pagestrD);
