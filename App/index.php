	...
	<div class="main-container">
		<div id="menu-container" class="container" style="display: block;">
			...
			<div id="mainList" class="main">
				<div id="itemsList" class="items">
					<!-- 插入商品列表 -->
				<?php 
					$sql = "select * from ".DB_PREFIX."menu where status=\"1\"";
		...
		<div id="delivery-container" class="container" style="display: none;">
			<div class="confirmation-form">
				...
				<?php
			  	  	  $sqlUserBalance = "SELECT * FROM ".DB_PREFIX."users WHERE uid=\"$_GET[uid]\"";
							...
							<tr>
								...
								<td class="td_right">
									<input type="text" name="username" id="username"
										placeholder="务必使用真实姓名" value="<?php echo $UserBalance['username'];?>" required="">
								</td>
							</tr>
							<tr>
								...
								<td class="td_right">
									<input type="text" name="tel" id="tel" placeholder="请输入手机号"
										value="<?php echo $UserBalance['phone'];?>" required="">
								</td>
							</tr>
							...
							<tr>
								...
								<td class="td_right">
									<input type="text" name="address" id="address"
										placeholder="请输入详细地址" value="<?php echo $UserBalance['address'];?>" required="">
								</td>
							</tr>
							<tr>
			...
			<!-- 正在提交数据 -->	
			<div id="menu-shadow" hidefocus="true" style="display: none;">
					
				<div class="btn-group"  style="position:fixed;width:160px;bottom:80px;left:50%; margin-left: -95px;">
				    <div class="btn" style="width:100%;margin:0px;"><img src="./static/images/ajax-loader.gif" alt="loader">正在提交订单...</div>
				</div>
			</div>
		</div>
