      ...
      <table class="table  table-bordered table-hover">
		  ...
		  <?php if(is_array($orders)): $i = 0; $__LIST__ = $orders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			    ...
			    <td class="text-center">
			    	<?php $__FOR_START_31751__=1;$__FOR_END_31751__=$vo["length"];for($i=$__FOR_START_31751__;$i < $__FOR_END_31751__;$i+=1){ echo ($vo["$i"]["title"]); ?>-<?php echo ($vo["$i"]["price"]); ?>-<?php echo ($vo["$i"]["quantity"]); ?>|<?php } ?>
			    </td>
