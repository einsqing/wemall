...
<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li  id="dingdan">
						<a href="__MODULE__/Admin/index">订单</a>
					</li>
					<li class="dropdown active" id="shangpin">
						...
						<ul class="dropdown-menu active">
							<li>
								<a href="__MODULE__/Admin/productcate">商品分类</a>
							</li>
							<li>
								<a href="__MODULE__/Admin/product">商品管理</a>
							</li>
						</ul>
					</li>
					<li class="dropdown" id="weixinset">
						...
						<ul class="dropdown-menu">
							<li>
								<a href="__MODULE__/Weixin/index" id="weixinset">微信初始化</a>
							</li>
						</ul>
					</li>
				</ul>
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						<a href="__MODULE__/Admin/quit">退出</a>
					</li>
				</ul>
			</div>
			<!--/.nav-collapse -->
	...
	<form class="form-horizontal" role="form" method="post"
		action="__CONTROLLER__/reproductcate">
		<?php if(is_array($nav)): $i = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$navid): $mod = ($i % 2 );++$i;?><div class="form-group">
			<label for="title" class="col-sm-2 control-label">分类{<?php echo ($navid["id"]); ?>}</label>
			<div class="col-sm-5">
		...
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				...
				<a href="__CONTROLLER__/addnav" class="btn btn-primary">增加分类</a>
			</div>
		</div>
	</form>
</div>
