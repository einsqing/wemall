...
<div class="container">
	<table class="table">
		<div class="text-left" style="padding-left:90px;">微商接口配置URL: <code>http://wemall.duapp.com/weixin.php</code></div>
		<div class="text-left" style="padding-left:90px;">微商接口配置Token: <code>wemall</code></div>
	</table>
